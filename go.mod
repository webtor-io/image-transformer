...
require (
	...
	github.com/webtor-io/common-services v0.0.0-20200624203531-dfc5c3497336
	github.com/webtor-io/video-thumbnails-generator v0.0.0-20200805212449-3daac2eefdf2 // indirect
